          ...
          <div className='col-12'>
            ...
            <div className='col-12 py-2 mt-4'>
              <div className='d-flex justify-content-between align-items-baseline'>
                <Link to='/home/store' className='button' style={{ fontSize: '1rem', color: 'white', fontWeight: 'bold' }}>
                ...
                {(userCart == null || userCart.length === 0) ? (
                  ...
                  <div className='d-flex flex-column align-items-end'>
                    ...
                    <Link to='/home/checkout' className='button' style={{ fontSize: '1rem', color: 'white', fontWeight: 'bold' }}>
                      Checkout
                    </Link>
                  </div>
                )}
