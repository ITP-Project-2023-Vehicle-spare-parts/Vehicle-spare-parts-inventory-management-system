  ...
  function EmailLink(props) {
    return (
        <Card fluid>
            <Card.Content>
                <Card.Description>
                    Our support team is available 24/7. Click on the 'Support' tab to get assistance or
...
function LowStockItemsList() {
  ...
  return (
    <div>Low Stock Items & Need Count Is:
        {stocks.length > 0 ? (
            <ul style={listStyle}>
      ...
      <div> 
          ...
          {branches.length > 0 ? (
              branches.map((branch, index) => (
                  <Label key={branch._id} color='red' size='large' style={{ display: 'block', marginTop: '5px' }}>
  ...
  return (
    <div style={{
      ...
      <p style={{
        ...
        Thank you for using our chatbot. If you need assistance again, just start a new chat. <span style={{color: '#4CAF50'}}>🌟</span>
      </p>
      <p style={{
        fontStyle: 'italic',
        color: '#777'
...
function WelcomeMessage() {
  return (
    <div style={{
      ...
      <h2 style={{color: "#003366", marginTop: "10px"}}>Welcome to CM Spare Parts!</h2>
      <p style={{fontSize: "1.1em", margin: "10px 0"}}>Where your vehicle's needs come first. We're thrilled to have you here.</p>
      <p style={{fontWeight: "bold", color: "#007BFF"}}>How can we drive your queries today?</p>
...
},
{
  ...
  trigger: "main-questions",
},
    {
        id: "main-questions",
        options: [
            { value: "get-started", label: "Getting Started", trigger: "get-started-answer" },
            { value: "contact-stock-menager", label: "Contact Stock Menager", trigger: "contact-stock-menager-answer" },
            { value: "view-Stock-Level", label: "Shop Stock Level", trigger: "View-Stock-Level-answer" },
            { value: "view-low-orders", label: "Viewing Low Orders", trigger: "view-low-orders-answer" },
            { value: "view-branch-detail", label: "Viewing Btanch Details", trigger: "view-branch-detail-answer" },
    ...
    },
    {
        ...
        message: "Get Start to Analyse Stock And Set The Week Order List.Which item low To stock can fill it...",
        trigger: "main-questions"
    },
    {
      ...
      <Segment className="chatbot-container" floated="right">
                {showBot ? (
                    <div>
                        ...
                        <button onClick={() => setShowBot(false)}><i class='bx bx-x bx-sm'></i></button>
                    </div>
                ) : (
                    <img 
                        ...
                        style={{cursor: 'pointer' ,width:'75px' , height:'75px',backgroundColor:"#ffffff00", border: 'none'}}
                    />
                )}
            </Segment>
    </div>
